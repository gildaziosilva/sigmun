# sigmun_ouvidoria — índice do módulo
...
- Código-fonte: [sigmun_ouvidoria](../../../src/modules/sigmun_ouvidoria).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-OUV](../../DOM-OUV/index.md).
- MOD **proposto, não aprovado**: `MOD-OUV`.
...
- [domain](../../../src/modules/sigmun_ouvidoria/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_ouvidoria/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_ouvidoria/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_ouvidoria/presentation) — estrutura preparada
