# sigmun_planejamento — índice do módulo
...
- Código-fonte: [sigmun_planejamento](../../../src/modules/sigmun_planejamento).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-PLA](../../DOM-PLA/index.md).
- MOD **proposto, não aprovado**: `MOD-PLA`.
...
- [domain](../../../src/modules/sigmun_planejamento/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_planejamento/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_planejamento/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_planejamento/presentation) — estrutura preparada
