# sigmun_frotas — índice do módulo
...
- Código-fonte: [sigmun_frotas](../../../src/modules/sigmun_frotas).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-FRO](../../DOM-FRO/index.md).
- MOD **proposto, não aprovado**: `MOD-FRO`.
...
- [domain](../../../src/modules/sigmun_frotas/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_frotas/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_frotas/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_frotas/presentation) — estrutura preparada
