# sigmun_educacao — índice do módulo
...
- Código-fonte: [sigmun_educacao](../../../src/modules/sigmun_educacao).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-EDU](../../DOM-EDU/index.md).
- MOD **proposto, não aprovado**: `MOD-EDU`.
...
- [domain](../../../src/modules/sigmun_educacao/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_educacao/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_educacao/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_educacao/presentation) — estrutura preparada
