...
- Código-fonte: [sigmun_saude](../../../src/modules/sigmun_saude).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-SAU](../../DOM-SAU/index.md).
- MOD **proposto, não aprovado**: `MOD-SAU`.
...
- [domain](../../../src/modules/sigmun_saude/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_saude/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_saude/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_saude/presentation) — estrutura preparada
