# sigmun_tributos — índice do módulo
...
- Código-fonte: [sigmun_tributos](../../../src/modules/sigmun_tributos).
- Verificação estática: 17/09/2026, base `51c82dc`.
- Domínio candidato: [DOM-TRI](../../DOM-TRI/index.md).
- MOD **proposto, não aprovado**: `MOD-TRI`.
...
- [domain](../../../src/modules/sigmun_tributos/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_tributos/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_tributos/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_tributos/presentation) — estrutura preparada
