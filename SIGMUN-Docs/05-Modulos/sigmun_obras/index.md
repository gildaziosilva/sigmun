...
- Domínio candidato: [DOM-OBR](../../DOM-OBR/index.md).
- MOD **proposto, não aprovado**: `MOD-OBR`.
...
- [domain](../../../src/modules/sigmun_obras/domain) — estrutura preparada
- [application](../../../src/modules/sigmun_obras/application) — estrutura preparada
- [infrastructure](../../../src/modules/sigmun_obras/infrastructure) — estrutura preparada
- [presentation](../../../src/modules/sigmun_obras/presentation) — estrutura preparada
