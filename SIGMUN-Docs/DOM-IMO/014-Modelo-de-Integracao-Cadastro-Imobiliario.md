# 014 – Modelo de Integração – Cadastro Imobiliário

#### Modelo de Integração – Cadastro Imobiliário
...
O **Modelo de Integração – Cadastro Imobiliário** (`DOM-IMO`) tem como finalidade mapear e definir modelo de integração do domínio.
...
**Documento:** 014-Modelo-de-Integracao-Cadastro-Imobiliario.md
