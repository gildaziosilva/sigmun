# 015 – Arquitetura de Serviços – Cadastro Imobiliário

#### Arquitetura de Serviços – Cadastro Imobiliário
...
O **Arquitetura de Serviços – Cadastro Imobiliário** (`DOM-IMO`) tem como finalidade mapear e definir arquitetura de serviços do domínio.
...
**Documento:** 015-Arquitetura-de-Servicos-Cadastro-Imobiliario.md
