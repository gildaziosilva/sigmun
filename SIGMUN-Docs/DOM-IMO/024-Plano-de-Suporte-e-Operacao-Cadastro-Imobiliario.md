# 024 – Plano de Suporte e Operação – Cadastro Imobiliário

#### Plano de Suporte e Operação – Cadastro Imobiliário
...
O **Plano de Suporte e Operação – Cadastro Imobiliário** (`DOM-IMO`) tem como finalidade mapear e definir plano de suporte e operação do domínio.
...
**Documento:** 024-Plano-de-Suporte-e-Operacao-Cadastro-Imobiliario.md
