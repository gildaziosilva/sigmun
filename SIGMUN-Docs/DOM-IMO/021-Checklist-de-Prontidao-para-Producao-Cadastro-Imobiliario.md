# 021 – Checklist de Prontidão para Produção – Cadastro Imobiliário

#### Checklist de Prontidão para Produção – Cadastro Imobiliário
...
O **Checklist de Prontidão para Produção – Cadastro Imobiliário** (`DOM-IMO`) tem como finalidade mapear e definir checklist de prontidão para produção do domínio.
...
**Documento:** 021-Checklist-de-Prontidao-para-Producao-Cadastro-Imobiliario.md
