# 022 – Plano de Migração de Dados – Geoinformação Municipal

#### Plano de Migração de Dados – Geoinformação Municipal
...
O **Plano de Migração de Dados – Geoinformação Municipal** (`DOM-GEO`) tem como finalidade mapear e definir plano de migração de dados do domínio.
...
**Documento:** 022-Plano-de-Migracao-de-Dados-Geoinformacao-Municipal.md
