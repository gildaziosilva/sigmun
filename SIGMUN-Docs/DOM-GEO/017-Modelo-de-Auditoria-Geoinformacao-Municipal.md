# 017 – Modelo de Auditoria – Geoinformação Municipal

#### Modelo de Auditoria – Geoinformação Municipal
...
O **Modelo de Auditoria – Geoinformação Municipal** (`DOM-GEO`) tem como finalidade mapear e definir modelo de auditoria do domínio.
...
**Documento:** 017-Modelo-de-Auditoria-Geoinformacao-Municipal.md
