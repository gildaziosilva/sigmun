# 021 – Checklist de Prontidão para Produção – Geoinformação Municipal

#### Checklist de Prontidão para Produção – Geoinformação Municipal
...
O **Checklist de Prontidão para Produção – Geoinformação Municipal** (`DOM-GEO`) tem como finalidade mapear e definir checklist de prontidão para produção do domínio.
...
**Documento:** 021-Checklist-de-Prontidao-para-Producao-Geoinformacao-Municipal.md
