# 016 – Modelo de Segurança – Geoinformação Municipal

#### Modelo de Segurança – Geoinformação Municipal
...
O **Modelo de Segurança – Geoinformação Municipal** (`DOM-GEO`) tem como finalidade mapear e definir modelo de segurança do domínio.
...
**Documento:** 016-Modelo-de-Seguranca-Geoinformacao-Municipal.md
