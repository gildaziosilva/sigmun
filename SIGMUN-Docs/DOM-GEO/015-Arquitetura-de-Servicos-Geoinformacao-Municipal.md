# 015 – Arquitetura de Serviços – Geoinformação Municipal

#### Arquitetura de Serviços – Geoinformação Municipal
...
O **Arquitetura de Serviços – Geoinformação Municipal** (`DOM-GEO`) tem como finalidade mapear e definir arquitetura de serviços do domínio.
...
**Documento:** 015-Arquitetura-de-Servicos-Geoinformacao-Municipal.md
