# 002 – Mapa de Capacidades – Gestão de Pessoas

#### Mapa de Capacidades – Gestão de Pessoas
...
O **Mapa de Capacidades – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir mapa de capacidades do domínio.
...
**Documento:** 002-Mapa-de-Capacidades-Gestao-de-Pessoas.md
