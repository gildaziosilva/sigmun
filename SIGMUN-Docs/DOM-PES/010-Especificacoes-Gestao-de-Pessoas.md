# 010 – Especificações – Gestão de Pessoas

#### Especificações – Gestão de Pessoas
...
O **Especificações – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir especificações do domínio.
...
**Documento:** 010-Especificacoes-Gestao-de-Pessoas.md
