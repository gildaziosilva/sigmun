# 004 – Mapa de Serviços – Gestão de Pessoas

#### Mapa de Serviços – Gestão de Pessoas
...
O **Mapa de Serviços – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir mapa de serviços do domínio.
...
**Documento:** 004-Mapa-de-Servicos-Gestao-de-Pessoas.md
