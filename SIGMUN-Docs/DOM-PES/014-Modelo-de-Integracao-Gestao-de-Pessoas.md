# 014 – Modelo de Integração – Gestão de Pessoas

#### Modelo de Integração – Gestão de Pessoas
...
O **Modelo de Integração – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir modelo de integração do domínio.
...
**Documento:** 014-Modelo-de-Integracao-Gestao-de-Pessoas.md
