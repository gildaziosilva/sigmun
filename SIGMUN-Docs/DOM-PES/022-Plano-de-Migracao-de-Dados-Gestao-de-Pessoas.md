# 022 – Plano de Migração de Dados – Gestão de Pessoas

#### Plano de Migração de Dados – Gestão de Pessoas
...
O **Plano de Migração de Dados – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir plano de migração de dados do domínio.
...
**Documento:** 022-Plano-de-Migracao-de-Dados-Gestao-de-Pessoas.md
