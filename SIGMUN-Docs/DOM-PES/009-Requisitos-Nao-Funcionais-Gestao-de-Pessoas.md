# 009 – Requisitos Não Funcionais – Gestão de Pessoas

#### Requisitos Não Funcionais – Gestão de Pessoas
...
O **Requisitos Não Funcionais – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir requisitos não funcionais do domínio.
...
**Documento:** 009-Requisitos-Nao-Funcionais-Gestao-de-Pessoas.md
