# 017 – Modelo de Auditoria – Gestão de Pessoas

#### Modelo de Auditoria – Gestão de Pessoas
...
O **Modelo de Auditoria – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir modelo de auditoria do domínio.
...
**Documento:** 017-Modelo-de-Auditoria-Gestao-de-Pessoas.md
