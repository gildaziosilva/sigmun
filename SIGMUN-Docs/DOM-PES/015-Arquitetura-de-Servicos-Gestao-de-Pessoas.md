# 015 – Arquitetura de Serviços – Gestão de Pessoas

#### Arquitetura de Serviços – Gestão de Pessoas
...
O **Arquitetura de Serviços – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir arquitetura de serviços do domínio.
...
**Documento:** 015-Arquitetura-de-Servicos-Gestao-de-Pessoas.md
