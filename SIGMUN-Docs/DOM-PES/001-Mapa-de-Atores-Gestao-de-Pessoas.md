# 001 – Mapa de Atores – Gestão de Pessoas

#### Mapa de Atores – Gestão de Pessoas
...
O **Mapa de Atores – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir identificação dos atores do domínio.
...
**Documento:** 001-Mapa-de-Atores-Gestao-de-Pessoas.md
