# 016 – Modelo de Segurança – Gestão de Pessoas

#### Modelo de Segurança – Gestão de Pessoas
...
O **Modelo de Segurança – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir modelo de segurança do domínio.
...
**Documento:** 016-Modelo-de-Seguranca-Gestao-de-Pessoas.md
