# 003 – Mapa de Processos – Gestão de Pessoas

#### Mapa de Processos – Gestão de Pessoas
...
O **Mapa de Processos – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir mapa de processos do domínio.
...
**Documento:** 003-Mapa-de-Processos-Gestao-de-Pessoas.md
