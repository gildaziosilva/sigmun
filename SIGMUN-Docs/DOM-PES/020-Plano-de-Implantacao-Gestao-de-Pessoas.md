# 020 – Plano de Implantação – Gestão de Pessoas

#### Plano de Implantação – Gestão de Pessoas
...
O **Plano de Implantação – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir plano de implantação do domínio.
...
**Documento:** 020-Plano-de-Implantacao-Gestao-de-Pessoas.md
