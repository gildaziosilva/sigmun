# 018 – Plano de Testes – Gestão de Pessoas

#### Plano de Testes – Gestão de Pessoas
...
O **Plano de Testes – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir plano de testes do domínio.
...
**Documento:** 018-Plano-de-Testes-Gestao-de-Pessoas.md
