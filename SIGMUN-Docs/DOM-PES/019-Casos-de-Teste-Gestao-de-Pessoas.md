# 019 – Casos de Teste – Gestão de Pessoas

#### Casos de Teste – Gestão de Pessoas
...
O **Casos de Teste – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir casos de teste do domínio.
...
**Documento:** 019-Casos-de-Teste-Gestao-de-Pessoas.md
