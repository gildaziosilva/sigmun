# 024 – Plano de Suporte e Operação – Gestão de Pessoas

#### Plano de Suporte e Operação – Gestão de Pessoas
...
O **Plano de Suporte e Operação – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir plano de suporte e operação do domínio.
...
**Documento:** 024-Plano-de-Suporte-e-Operacao-Gestao-de-Pessoas.md
