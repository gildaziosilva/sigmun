# 006 – Histórias de Usuário – Gestão de Pessoas

#### Histórias de Usuário – Gestão de Pessoas
...
O **Histórias de Usuário – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir histórias de usuário do domínio.
...
**Documento:** 006-Historias-de-Usuario-Gestao-de-Pessoas.md
