# 012 – Matriz de Rastreabilidade – Gestão de Pessoas

#### Matriz de Rastreabilidade – Gestão de Pessoas
...
O **Matriz de Rastreabilidade – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir matriz de rastreabilidade do domínio.
...
**Documento:** 012-Matriz-de-Rastreabilidade-Gestao-de-Pessoas.md
