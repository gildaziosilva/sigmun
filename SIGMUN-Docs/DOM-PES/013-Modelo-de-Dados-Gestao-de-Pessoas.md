# 013 – Modelo de Dados – Gestão de Pessoas

#### Modelo de Dados – Gestão de Pessoas
...
O **Modelo de Dados – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir modelo de dados do domínio do domínio.
...
**Documento:** 013-Modelo-de-Dados-Gestao-de-Pessoas.md
