# 008 – Requisitos Funcionais – Gestão de Pessoas

#### Requisitos Funcionais – Gestão de Pessoas
...
O **Requisitos Funcionais – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir requisitos funcionais do domínio.
...
**Documento:** 008-Requisitos-Funcionais-Gestao-de-Pessoas.md
