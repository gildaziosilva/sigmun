# 005 – Casos de Uso – Gestão de Pessoas
...
O **Casos de Uso – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir casos de uso do domínio.
...
**Documento:** 005-Casos-de-Uso-Gestao-de-Pessoas.md
