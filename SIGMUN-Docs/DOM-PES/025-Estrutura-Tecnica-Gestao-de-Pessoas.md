# 025 – Estrutura Técnica – Gestão de Pessoas

#### Estrutura Técnica – Gestão de Pessoas
...
O **Estrutura Técnica – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir estrutura técnica do domínio.
...
**Documento:** 025-Estrutura-Tecnica-Gestao-de-Pessoas.md
