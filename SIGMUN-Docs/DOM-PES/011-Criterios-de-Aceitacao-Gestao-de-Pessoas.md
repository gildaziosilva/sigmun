# 011 – Critérios de Aceitação – Gestão de Pessoas

#### Critérios de Aceitação – Gestão de Pessoas
...
O **Critérios de Aceitação – Gestão de Pessoas** (`DOM-PES`) tem como finalidade mapear e definir critérios de aceitação do domínio.
...
**Documento:** 011-Criterios-de-Aceitacao-Gestao-de-Pessoas.md
