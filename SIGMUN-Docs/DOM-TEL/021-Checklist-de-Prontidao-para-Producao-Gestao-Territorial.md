...
O **Checklist de Prontidão para Produção – Gestão Territorial** (`DOM-TEL`) tem como finalidade mapear e definir checklist de prontidão para produção do domínio.
