# 022 – Plano de Migração de Dados – Gestão Territorial

#### Plano de Migração de Dados – Gestão Territorial
...
O **Plano de Migração de Dados – Gestão Territorial** (`DOM-TEL`) tem como finalidade mapear e definir plano de migração de dados do domínio.
...
**Documento:** 022-Plano-de-Migracao-de-Dados-Gestao-Territorial.md
