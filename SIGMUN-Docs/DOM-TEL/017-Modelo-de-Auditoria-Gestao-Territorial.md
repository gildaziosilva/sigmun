# 017 – Modelo de Auditoria – Gestão Territorial

#### Modelo de Auditoria – Gestão Territorial
...
O **Modelo de Auditoria – Gestão Territorial** (`DOM-TEL`) tem como finalidade mapear e definir modelo de auditoria do domínio.
...
**Documento:** 017-Modelo-de-Auditoria-Gestao-Territorial.md
