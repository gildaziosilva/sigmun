# 010 – Especificações – Cadastro Único Municipal

#### Especificações – Cadastro Único Municipal
...
O **Especificações – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir especificações do domínio.
...
**Documento:** 010-Especificacoes-Cadastro-Unico-Municipal.md
