# 021 – Checklist de Prontidão para Produção – Cadastro Único Municipal

#### Checklist de Prontidão para Produção – Cadastro Único Municipal
...
O **Checklist de Prontidão para Produção – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir checklist de prontidão para produção do domínio.
...
**Documento:** 021-Checklist-de-Prontidao-para-Producao-Cadastro-Unico-Municipal.md
