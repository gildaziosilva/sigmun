# 013 – Modelo de Dados – Cadastro Único Municipal

#### Modelo de Dados – Cadastro Único Municipal
...
O **Modelo de Dados – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir modelo de dados do domínio do domínio.
...
**Documento:** 013-Modelo-de-Dados-Cadastro-Unico-Municipal.md
