# 026 – Modelo de Domínio – Cadastro Único Municipal

#### Modelo de Domínio – Cadastro Único Municipal
...
O **Modelo de Domínio – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir modelo de domínio do domínio.
...
**Documento:** 026-Modelo-de-Dominio-Cadastro-Unico-Municipal.md
