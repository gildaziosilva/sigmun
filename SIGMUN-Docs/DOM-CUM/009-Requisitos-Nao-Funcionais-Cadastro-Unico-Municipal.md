# 009 – Requisitos Não Funcionais – Cadastro Único Municipal

#### Requisitos Não Funcionais – Cadastro Único Municipal
...
O **Requisitos Não Funcionais – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir requisitos não funcionais do domínio.
...
**Documento:** 009-Requisitos-Nao-Funcionais-Cadastro-Unico-Municipal.md
