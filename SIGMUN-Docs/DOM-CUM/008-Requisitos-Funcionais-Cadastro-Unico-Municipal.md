# 008 – Requisitos Funcionais – Cadastro Único Municipal

#### Requisitos Funcionais – Cadastro Único Municipal
...
O **Requisitos Funcionais – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir requisitos funcionais do domínio.
...
**Documento:** 008-Requisitos-Funcionais-Cadastro-Unico-Municipal.md
