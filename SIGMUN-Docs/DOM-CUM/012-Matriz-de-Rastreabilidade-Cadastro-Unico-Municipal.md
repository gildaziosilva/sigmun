# 012 – Matriz de Rastreabilidade – Cadastro Único Municipal

#### Matriz de Rastreabilidade – Cadastro Único Municipal
...
O **Matriz de Rastreabilidade – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir matriz de rastreabilidade do domínio.
...
**Documento:** 012-Matriz-de-Rastreabilidade-Cadastro-Unico-Municipal.md
