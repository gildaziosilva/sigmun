# 022 – Plano de Migração de Dados – Cadastro Único Municipal

#### Plano de Migração de Dados – Cadastro Único Municipal
...
O **Plano de Migração de Dados – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir plano de migração de dados do domínio.
...
**Documento:** 022-Plano-de-Migracao-de-Dados-Cadastro-Unico-Municipal.md
