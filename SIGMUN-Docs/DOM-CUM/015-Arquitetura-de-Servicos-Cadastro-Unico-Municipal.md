# 015 – Arquitetura de Serviços – Cadastro Único Municipal

#### Arquitetura de Serviços – Cadastro Único Municipal
...
O **Arquitetura de Serviços – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir arquitetura de serviços do domínio.
...
**Documento:** 015-Arquitetura-de-Servicos-Cadastro-Unico-Municipal.md
