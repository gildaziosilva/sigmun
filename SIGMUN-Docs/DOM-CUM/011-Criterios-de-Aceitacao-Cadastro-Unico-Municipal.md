# 011 – Critérios de Aceitação – Cadastro Único Municipal

#### Critérios de Aceitação – Cadastro Único Municipal
...
O **Critérios de Aceitação – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir critérios de aceitação do domínio.
...
**Documento:** 011-Criterios-de-Aceitacao-Cadastro-Unico-Municipal.md
