# 017 – Modelo de Auditoria – Cadastro Único Municipal

#### Modelo de Auditoria – Cadastro Único Municipal
...
O **Modelo de Auditoria – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir modelo de auditoria do domínio.
...
**Documento:** 017-Modelo-de-Auditoria-Cadastro-Unico-Municipal.md
