# 004 – Mapa de Serviços – Cadastro Único Municipal

#### Mapa de Serviços – Cadastro Único Municipal
...
O **Mapa de Serviços – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir mapa de serviços do domínio.
...
**Documento:** 004-Mapa-de-Servicos-Cadastro-Unico-Municipal.md
