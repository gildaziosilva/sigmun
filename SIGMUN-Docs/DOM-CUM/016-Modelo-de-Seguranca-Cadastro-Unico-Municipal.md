# 016 – Modelo de Segurança – Cadastro Único Municipal

#### Modelo de Segurança – Cadastro Único Municipal
...
O **Modelo de Segurança – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir modelo de segurança do domínio.
...
**Documento:** 016-Modelo-de-Seguranca-Cadastro-Unico-Municipal.md
