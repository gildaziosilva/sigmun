# 006 – Histórias de Usuário – Cadastro Único Municipal

#### Histórias de Usuário – Cadastro Único Municipal
...
O **Histórias de Usuário – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir histórias de usuário do domínio.
...
**Documento:** 006-Historias-de-Usuario-Cadastro-Unico-Municipal.md
