# 020 – Plano de Implantação – Cadastro Único Municipal

#### Plano de Implantação – Cadastro Único Municipal
...
O **Plano de Implantação – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir plano de implantação do domínio.
...
**Documento:** 020-Plano-de-Implantacao-Cadastro-Unico-Municipal.md
