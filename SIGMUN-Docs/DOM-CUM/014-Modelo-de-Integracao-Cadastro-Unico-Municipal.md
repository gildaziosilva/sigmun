# 014 – Modelo de Integração – Cadastro Único Municipal

#### Modelo de Integração – Cadastro Único Municipal
...
O **Modelo de Integração – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir modelo de integração do domínio.
...
**Documento:** 014-Modelo-de-Integracao-Cadastro-Unico-Municipal.md
