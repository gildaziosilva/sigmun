# 018 – Plano de Testes – Cadastro Único Municipal

#### Plano de Testes – Cadastro Único Municipal
...
O **Plano de Testes – Cadastro Único Municipal** (`DOM-CUM`) tem como finalidade mapear e definir plano de testes do domínio.
...
**Documento:** 018-Plano-de-Testes-Cadastro-Unico-Municipal.md
