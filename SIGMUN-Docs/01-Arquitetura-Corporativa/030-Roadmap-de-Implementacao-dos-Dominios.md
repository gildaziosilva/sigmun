...
| PostgreSQL | 🟡 Em preparação |
| SQLAlchemy | 🟡 Em preparação |
| Alembic | 🟡 Estrutura inicial |
| Migrações | 🟡 Primeiras revisões em preparação |
...
3. Criar migrações para `core` e `compras`.
4. Implementar fornecedores.
5. Implementar itens e produtos/serviços.
6. Implementar solicitações e processos de compras.
7. Implementar processos documentais.
